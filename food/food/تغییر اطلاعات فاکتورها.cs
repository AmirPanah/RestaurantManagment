...
namespace food
{
    public partial class تغییر_اطلاعات_فاکتورها : Form
    {

        
        لیست_فاکتور f1 = new لیست_فاکتور();
        public تغییر_اطلاعات_فاکتورها(لیست_فاکتور ff)
        {
            InitializeComponent();
            f1 = ff;
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("جمع فاکتور:" + txtProNet1.Text + "", dataGridView2.Font, new SolidBrush(Color.Black), new Point(600, 130 + dataGridView2.Rows[0].Height * i));

            e.Graphics.DrawString("تخفیف:" + takhfifi.ToString() + "", dataGridView2.Font, new SolidBrush(Color.Black), new Point(200, 130 + dataGridView2.Rows[0].Height * i));

            e.Graphics.DrawString("جمع نهایی فاکتور:" + txtProNet2.Text + "", dataGridView2.Font, new SolidBrush(Color.Black), new Point(400, 160 + dataGridView2.Rows[0].Height * i));
