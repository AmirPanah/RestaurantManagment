...
namespace food
{
    public partial class factor : Form
    {
        ...
        {
            SqlConnection objcon = new SqlConnection("Data Source=Localhost;Initial Catalog=FoodDB; Integrated Security=True");
            SqlDataAdapter objadapter = new SqlDataAdapter("Select Name,Number,Price,SumPrice from Factor where Factorid='" + Int64.Parse(lbfactorid.Text) + "'", objcon);
            DataSet objset = new DataSet();
        ...
        private void factor_Load(object sender, EventArgs e)
        {
            ...
            label7.Text = DateDay + "   " + DateTime.Now.Hour.ToString() + ":" + DateTime.Now.Minute.ToString() + ":" + DateTime.Now.Second.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string selectCmd = string.Format("Select * from Factor where Factorid='" + Int64.Parse(lbfactorid.Text) + "' and  Name=N'" + lblname.Text + "'");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DBManagment objclass = new DBManagment();
                objclass.Deleterowtable("Delete Factor where   Name=N'" + ss + "' and Factorid='" + Int64.Parse(lbfactorid.Text) + "' ");
                Loadgridview2();
                ...
                SqlDataAdapter objadapter2 = new SqlDataAdapter("Select SUM(SumPrice) as sum from Factor where Factorid='" + Int64.Parse(lbfactorid.Text) + "'", objcon2);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    DBManagment objdbclass = new DBManagment();
                    objdbclass.Updatetable("Update Factor Set takhfif='" + Int32.Parse(txtProtakhfif.TextValue.ToString()) + "'  , status='" + int.Parse("1") + "'  where Factorid='" + Int64.Parse(lbfactorid.Text) + "'  ");
                }
            ...
            if (successfullCreateAccount == false)
            {
                ...
                DBManagment objclass = new DBManagment();
                objclass.Deleterowtable("Delete Factor where  Factorid='" + Int64.Parse(lbfactorid.Text) + "' ");
                Loadgridview2();
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            // e.Graphics.DrawString("شماره فاکتور", dataGridView2.Font, new SolidBrush(Color.Black), new Point(600, 70));
            e.Graphics.DrawString(label7.Text, label8.Font, new SolidBrush(Color.Black), new Point(600, 70));
            e.Graphics.DrawString(lbfactorid.Text, label8.Font, new SolidBrush(Color.Black), new Point(200, 70));
            //برای ستون نام
            ...
            e.Graphics.DrawString(dataGridView2.Columns[4].HeaderText.ToString(), label8.Font, Brushes.Black, new Rectangle(200, 100, dataGridView2.Columns[4].Width, dataGridView2.Rows[0].Height));
            // آدرس 
            ...
            e.Graphics.DrawString(dataGridView2.Columns[3].HeaderText.ToString(), label8.Font, Brushes.Black, new Rectangle(300, 100, dataGridView2.Columns[3].Width, dataGridView2.Rows[0].Height));
            //تلفن
            ...
            e.Graphics.DrawString(dataGridView2.Columns[2].HeaderText.ToString(), label8.Font, Brushes.Black, new Rectangle(400, 100, dataGridView2.Columns[2].Width, dataGridView2.Rows[0].Height));
            //
            ...
            e.Graphics.DrawString(dataGridView2.Columns[1].HeaderText.ToString(), label8.Font, Brushes.Black, new Rectangle(500, 100, dataGridView2.Columns[1].Width, dataGridView2.Rows[0].Height));
            ...
            e.Graphics.DrawString(dataGridView2.Columns[0].HeaderText.ToString(), label8.Font, Brushes.Black, new Rectangle(600, 100, dataGridView2.Columns[0].Width, dataGridView2.Rows[0].Height));
            ...
            while (i < dataGridView2.Rows.Count - 1)
            {
                ...
                e.Graphics.DrawString(dataGridView2.Rows[i].Cells[4].FormattedValue.ToString(), label8.Font, Brushes.Black, new Rectangle(100 + dataGridView2.Columns[3].Width, height, dataGridView2.Columns[3].Width, dataGridView2.Rows[0].Height));
                ...
                //اطلاعات
                e.Graphics.DrawString(dataGridView2.Rows[i].Cells[3].FormattedValue.ToString(), label8.Font, Brushes.Black, new Rectangle(200 + dataGridView2.Columns[3].Width, height, dataGridView2.Columns[3].Width, dataGridView2.Rows[0].Height));
                //ستون بعدی
                ...
                e.Graphics.DrawString(dataGridView2.Rows[i].Cells[2].FormattedValue.ToString(), label8.Font, Brushes.Black, new Rectangle(300 + dataGridView2.Columns[2].Width, height, dataGridView2.Columns[2].Width, dataGridView2.Rows[0].Height));
                //ستون بعدی
                ...
                e.Graphics.DrawString(dataGridView2.Rows[i].Cells[1].FormattedValue.ToString(), label8.Font, Brushes.Black, new Rectangle(400 + dataGridView2.Columns[1].Width, height, dataGridView2.Columns[1].Width, dataGridView2.Rows[0].Height));
                //ستون بعدی
                ...
                e.Graphics.DrawString(dataGridView2.Rows[i].Cells[0].FormattedValue.ToString(), label8.Font, Brushes.Black, new Rectangle(500 + dataGridView2.Columns[0].Width, height, dataGridView2.Columns[0].Width, dataGridView2.Rows[0].Height));
            ...
            e.Graphics.DrawString("جمع فاکتور:" + txtProNet1.Text + "", label8.Font, new SolidBrush(Color.Black), new Point(600, 130 + dataGridView2.Rows[0].Height * i));

            e.Graphics.DrawString("تخفیف:" + takhfifi.ToString() + "", label8.Font, new SolidBrush(Color.Black), new Point(200, 130 + dataGridView2.Rows[0].Height * i));

            e.Graphics.DrawString("جمع نهایی فاکتور:" + txtProNet2.Text + "", label8.Font, new SolidBrush(Color.Black), new Point(400, 160 + dataGridView2.Rows[0].Height * i));
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                objdbclass.Updatetable("Update Factor Set Number='" + tedade + "',SumPrice='" + tedade * pricee + "',Sood='" + sood * tedade + "'   where Name=N'" + name + "' and Factorid='" + Int64.Parse(lbfactorid.Text) + "'   ");
            ...
            {
                MessageBox.Show("امکان انجام عملیات مقدور نیست", "توجه");
