...
namespace food
{
    public partial class اطلاعات_بدهکاران : Form
    {
        بدهکار f1=new بدهکار();
        public اطلاعات_بدهکاران(بدهکار ff)
        {
            InitializeComponent();
            f1=ff;
        }
        ...
        private void اطلاعات_بدهکاران_Load(object sender, EventArgs e)
        {
            try
            {
